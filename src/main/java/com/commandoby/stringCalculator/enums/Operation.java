...
public enum Operation {
	...
	EXPONENTIETION("^", "\\^", 2, OperationType.FIRST) {
		@Override
	...
	CTG("ctg", "ctg|ctan", 1, OperationType.SECOND) {
		@Override
		public BigDecimal action(BigDecimal a, BigDecimal b) {
	...
	ACTG("arcctg", "arcctg|actg", 1, OperationType.SECOND) {
		@Override
		public BigDecimal action(BigDecimal a, BigDecimal b) {
	...
	PI("PI", "PI|pi", 0, OperationType.SPECIFIC) {
		@Override
		public BigDecimal action(BigDecimal a, BigDecimal b) {
			return BigDecimalMath.pi(new MathContext(WriterImpl.scale + 10)).stripTrailingZeros();
		}

	},
	E("e", "e", 0, OperationType.SPECIFIC) {
		@Override
		public BigDecimal action(BigDecimal a, BigDecimal b) {
			return BigDecimalMath.e(new MathContext(WriterImpl.scale + 10)).stripTrailingZeros();
		}
